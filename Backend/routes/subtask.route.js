...
subtaskRouter.post("/:taskId", auth_middleware_1.default, (req, res) =>
...
subtaskRouter.get("/:taskId", auth_middleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { taskId } = req.params;
...
subtaskRouter.patch("/:subtaskId", auth_middleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const userId =
      ...
      const subtaskToUpdate = yield subtask_model_1.default.findOne({
        _id: subtaskId,
      });
      if (!subtaskToUpdate) {
...
subtaskRouter.delete("/:subtaskId", auth_middleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { subtaskId } = req.params;
